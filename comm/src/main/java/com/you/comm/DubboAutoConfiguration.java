...
public class DubboAutoConfiguration {
    ...
    @Resource(name="protocolConfigRmi")
    private ProtocolConfig protocolConfig;

    @Resource(name="protocolConfigDubbo")
